...
: This option defines the access rule to limit who is permitted to use
...
: This option defines the length of the random string included in the
...
: When this option is set to `node`, the node identifier of the user's
...
: This option defines the permission bits of uploaded files. The bits
...
: Whether or not to store messages that lack a `<body/>` element. The default
